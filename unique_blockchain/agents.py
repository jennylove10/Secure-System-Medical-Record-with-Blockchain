...
class NMPA:
    def __init__(self, incompatibilities):
        ...
        self.nmpa_key = nacl.signing.SigningKey.generate()
        public_key = self.nmpa_key.verify_key
    ...
    def generate_authorization(self, doctor):
        ...
        with the private key of the NMPA
        Parameters
        ----------
        doctor
        ...
        signed = self.nmpa_key.sign(bytes(doctor.address, 'utf-8'))
        return signed
